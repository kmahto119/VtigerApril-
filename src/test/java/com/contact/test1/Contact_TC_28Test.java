...
public class Contact_TC_28Test extends BaseClass {
	@Test
public void SelectmultipleContactAndDeleteMassContactWithHeader() throws Throwable, Throwable{
	...
	for (int i = 3; i <= noOfRow+1; i++) {
			...
			Boolean first=(actfirstname.equals(flib.getExcelData("Sheet1", 23, 7)));
			boolean second=(actfirstname.equals(flib.getExcelData("Sheet1", 24, 7)));
